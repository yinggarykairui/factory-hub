...
| 003 | 2026-07-26 | pixel-garden | web | The garden now travels in a URL — share links, read-only visits | vanilla JS, canvas | 4.00 | [repo](https://github.com/yinggarykairui/pixel-garden) | [demo](https://yinggarykairui.github.io/pixel-garden/) | self-picked revisit (see HANDOFF.md) | claude-fable-5 |

**KPI:** streak: 3 · verified rate: 2/3 · avg rubric score: 4.17 · demos alive: 2/2
