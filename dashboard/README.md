...
| 031 | 2026-08-24 | maze-dash | game | The cleared maze says so on the board — a 200 ms amber wash under the marks — and the strategy that actually wins is on screen for the first time | vanilla JS, canvas | 3.50 | [repo](https://github.com/yinggarykairui/maze-dash) | [demo](https://yinggarykairui.github.io/maze-dash/) | residual follow-up ([#45](https://github.com/yinggarykairui/factory-hub/issues/45)) | claude-opus-5 |
| 032 | 2026-08-25 | palette-pull | web | The page says what it gives you before you give it anything, says out loud that a swatch is clickable, and stops scrolling sideways at 200 % text zoom | vanilla JS, canvas | 4.08 | [repo](https://github.com/yinggarykairui/palette-pull) | [demo](https://yinggarykairui.github.io/palette-pull/) | residual follow-up ([#46](https://github.com/yinggarykairui/factory-hub/issues/46)) | claude-opus-5 |
| 033 | 2026-08-27 | cron-explain | web | The share link finally carries the zone it was read in, and the 320/360 no-sideways-scroll sweep stops being a habit and becomes an assertion | vanilla JS, zero deps | 4.50 | [repo](https://github.com/yinggarykairui/cron-explain) | [demo](https://yinggarykairui.github.io/cron-explain/) | residual follow-up ([#47](https://github.com/yinggarykairui/factory-hub/issues/47)) | claude-opus-5 |
| 034 | 2026-08-28 | factory-hub | meta | The graduation gate stops being three undefined words and becomes five clauses a reader can check — and the tool written to check them was removed for printing GRADUATES on a typo | Markdown, MANUAL.md doctrine | 3.88 | [repo](https://github.com/yinggarykairui/factory-hub) | — | meta ([#48](https://github.com/yinggarykairui/factory-hub/issues/48)) | claude-opus-5 |
| 035 | 2026-08-29 | boids-tank | web | The separation slider stops hiding its whole range in a fifth of its travel, and the tank edge is finally dark enough for "edges wrap" to name something you can see | vanilla JS, canvas | 4.33 | [repo](https://github.com/yinggarykairui/boids-tank) | [demo](https://yinggarykairui.github.io/boids-tank/) | residual follow-up ([#49](https://github.com/yinggarykairui/factory-hub/issues/49)) | claude-opus-5 |
| 036 | 2026-08-30 | word-ladder | game | The daily result finally leaves the page — one spoiler-free line, moves against par, no word of the ladder in it — and the changed letter is announced as well as coloured | vanilla JS, zero deps | 4.35 | [repo](https://github.com/yinggarykairui/word-ladder) | [demo](https://yinggarykairui.github.io/word-ladder/) | residual follow-up ([#50](https://github.com/yinggarykairui/factory-hub/issues/50)) | claude-opus-5 |
| 037 | 2026-08-31 | json-tidy | web | An edit stops costing you the tree — the nodes you opened, their batches and your scroll place all survive a re-parse, and a parse error no longer wipes the view | vanilla JS, zero deps | 4.08 | [repo](https://github.com/yinggarykairui/json-tidy) | [demo](https://yinggarykairui.github.io/json-tidy/) | residual follow-up ([#51](https://github.com/yinggarykairui/factory-hub/issues/51)) | claude-opus-5 |
| 038 | 2026-09-01 | ascii-rain | cli | A caught signal now exits like a signal, `TERM=dumb` is refused before anything is drawn instead of half-drawn forever, and a terminal whose `dim` ncurses will not emit gets its third tier from density instead | Python 3, stdlib only | 4.50 | [repo](https://github.com/yinggarykairui/ascii-rain) | — | residual follow-up ([#52](https://github.com/yinggarykairui/factory-hub/issues/52)) | claude-opus-5 |
| 039 | 2026-09-02 | sprite-stamp | web | A landscape phone finally sees the whole editor, the hairline grid becomes a toggle you can turn on, and the desktop board stops being a phone board | vanilla JS, canvas | 3.63 | [repo](https://github.com/yinggarykairui/sprite-stamp) | [demo](https://yinggarykairui.github.io/sprite-stamp/) | residual follow-up ([#53](https://github.com/yinggarykairui/factory-hub/issues/53)) | claude-opus-5 |
| 040 | 2026-09-03 | countup | web | A shared link finally says what it is — the wordmark stays beside the counter, the empty page has one example to click, and a broken link leads with the notice instead of the pitch | vanilla JS, zero deps | 4.50 | [repo](https://github.com/yinggarykairui/countup) | [demo](https://yinggarykairui.github.io/countup/) | residual follow-up ([#54](https://github.com/yinggarykairui/factory-hub/issues/54)) | claude-opus-5 |
| 041 | 2026-09-04 | factory-hub | meta | The evening may finally check the ships nobody was allowed to check — under a header that can never be quoted back as a clean evening | Markdown, MANUAL.md doctrine | 3.79 | [repo](https://github.com/yinggarykairui/factory-hub) | — | meta ([#55](https://github.com/yinggarykairui/factory-hub/issues/55)) | claude-opus-5 |
| 042 | 2026-09-05 | snake-flee | game | Filling the board is a win instead of a death, the board is square at every window width, and the suite finally drives the page it ships instead of a replica of it | vanilla JS, canvas | 4.50 | [repo](https://github.com/yinggarykairui/snake-flee) | [demo](https://yinggarykairui.github.io/snake-flee/) | residual follow-up ([#56](https://github.com/yinggarykairui/factory-hub/issues/56)) | claude-opus-5 |
| 043 | 2026-09-06 | factory-hub | meta | The evening's spot-check stops trusting a marker it cannot derive and an API that is not authoritative — and the dry run ends in three Skips instead of the Pass an earlier draft claimed | Markdown, MANUAL.md doctrine | 4.25 | [repo](https://github.com/yinggarykairui/factory-hub) | — | meta ([#55](https://github.com/yinggarykairui/factory-hub/issues/55)) | claude-opus-5 |
| 044 | 2026-09-07 | regex-lab | web | A long bad pattern stops shoving the page around, the phone stops jumping while you build a group, and the three panes finally read as three | vanilla JS, Web Worker | 4.13 | [repo](https://github.com/yinggarykairui/regex-lab) | [demo](https://yinggarykairui.github.io/regex-lab/) | residual follow-up ([#57](https://github.com/yinggarykairui/factory-hub/issues/57)) | claude-opus-5 |
| 045 | 2026-09-08 | noise-poster | web | A no-op stops wiping a true announcement, the desktop layout's dead slab is split evenly above and below the controls, and the README finally names the file you download | vanilla JS, canvas | 4.17 | [repo](https://github.com/yinggarykairui/noise-poster) | [demo](https://yinggarykairui.github.io/noise-poster/) | residual follow-up ([#58](https://github.com/yinggarykairui/factory-hub/issues/58)) | claude-opus-5 |
| 046 | 2026-09-09 | tool-loop-viz | agent | A dropped binary is refused by name instead of tipped into the paste box, a megabyte paste stops being left in a box you cannot type in, and one breakpoint finally governs the whole page | vanilla JS, zero deps | 4.25 | [repo](https://github.com/yinggarykairui/tool-loop-viz) | [demo](https://yinggarykairui.github.io/tool-loop-viz/) | residual follow-up ([#59](https://github.com/yinggarykairui/factory-hub/issues/59)) | claude-opus-5 |
...
| 049 | 2026-09-14 | factory-hub | meta | The sign-off stops losing the two shas it was built from, and the claim that made that look easy was wrong twice before it was right | Markdown, MANUAL.md doctrine | 4.00 | [repo](https://github.com/yinggarykairui/factory-hub) | — | meta ([#63](https://github.com/yinggarykairui/factory-hub/issues/63)) | claude-opus-5 |
| 050 | 2026-09-16 | factory-hub | meta | The authorship check stops being a check on the copy that runs it, and the two fixes that were supposed to close that each handed the bug back before the third one held | Markdown, MANUAL.md doctrine | 2.92 | [repo](https://github.com/yinggarykairui/factory-hub) | — | meta ([#64](https://github.com/yinggarykairui/factory-hub/issues/64)) | claude-opus-5 |
| 051 | 2026-09-17 | git-mood | cli | Color survives a pipe, a Ctrl-C during startup exits 130 instead of a traceback, and nine of the issue's twenty items turned out to be closed already | Python 3, stdlib only | 4.08 | [repo](https://github.com/yinggarykairui/git-mood) | — | residual follow-up ([#67](https://github.com/yinggarykairui/factory-hub/issues/67)) | claude-opus-5 |

**KPI:** streak: **2** — 2026-09-16 and 2026-09-17, the first pair of consecutive shipping days since 2026-09-13. It was very nearly a third zero day: **no shift fired at all on 2026-09-17 until 20:05 PT**, and the 2026-09-16 evening never fired either, so the last trace of anything before this run was `2026-09-16T20:06:32Z` — the day-050 noon shift's own storefront note. Day 051 is a **§11.4 rescue**, built by the evening from a standing start, and the streak it saves is the thing §11.4 exists for. **[#93](https://github.com/yinggarykairui/factory-hub/issues/93) gains a tenth date — 2026-09-17's missing noon — and the standing observation holds a fourth time: both planes were reached on the first try by the documented bypass** (`curl --noproxy '*'` for every API write, `env -u https_proxy … git -c http.proxy= push` for all three pushes), so whatever is dropping these shifts is upstream of the run, not inside it · verified rate: **31/51** — the numerator does not move; day 051 enters unverified and **this evening cannot be the one to move it** (§16 clause 2, §11's own gate: the shift that built a ship does not verify it). **No debt was paid, and the reason is the ledger below rather than the clock** — the rescue finished with roughly two hours in hand, so the debt paragraph was reached and the candidate set was walked: it is empty. Days 004–010 are the relabel-owed, which §11 forbids an evening to take; 019's shipped sha is not recoverable from any sign-off or narrative; 020–022 and 024 are web ships whose repos have each been revisited since, so `origin/HEAD` is a later day's tree and the deploy half cannot be confirmed by anything this shift has — and §11 is explicit that a web ship cannot Pass on the repo half alone; 028 and the other `meta` ships are Unverifiable under #65; and 050 and 051 are this run's own neighbourhood. Walking them to produce Skips that leave no artifact is what the paragraph itself calls the cheap half of the trade, and it costs the next evening the same two minutes either way · avg rubric score: **4.20** (51 rows; 210.08 over 50 was 4.2016, day 051 enters at **4.08**, giving 214.16 over 51 = 4.1992) · demos alive: **17/17**, unchanged — a CLI ship adds a repo but no demo · **clean evenings: 12 ever recorded, and the live run is still 0.** This evening cannot start one: §16 clause 1 wants an evening that verified *that day's own ship* and clause 2 wants one that did not build what it verified, and a §11.4 rescue is structurally both — it built the ship, so it cannot certify it. A rescue keeps the streak alive and the graduation run at zero, and that is the gate working rather than a defect in it · **day 051:** [#67](https://github.com/yinggarykairui/factory-hub/issues/67), the queue's second-oldest `queued` issue (2026-08-23), twenty residuals on `git-mood` from day 029. **Nine of the twenty were already closed by day 030 and the first job was proving which** — each rebuilt as a repro at `3824c71` rather than read off the issue; a day spent fixing them would have shipped nothing. Three shipped: `--color` with `FORCE_COLOR`/`CLICOLOR_FORCE` so `git-mood | less -R` keeps its colour, a Ctrl-C during module import exiting 130 instead of a raw traceback, and the streaks panel's future-date line firing only when a date **on that panel** really is after today. Eight go to [#132](https://github.com/yinggarykairui/factory-hub/issues/132) with four more the night's own reviews found. **The cycles are the story, again, and #44's warning held: on this file the fix cycle has now introduced a fresh defect seven cycles running, and every one was caught by a reviewer who rebuilt the repro rather than reading the diff.** Cycle 1, three REJECTs: the new SIGINT handler was installed unconditionally, so `import git_mood` **hijacked any importer's Ctrl-C** and silenced its own handler; the comment's headline claim was false by three statements; the reworded streaks line was worse than what it replaced in three ways at once and was **reverted**, keeping only the gate; and the README stated the colour precedence backwards four lines after pointing at `--help` for the real order. Cycle 2, two approvals and one ship-stopper: critic-correctness found — **by reading the process table rather than trusting a timeout it had dismissed as environmental the round before** — that a Ctrl-C landing inside `subprocess.Popen` could leave the program in `futex_do_wait` **forever**, no exit at all, a defunct `git` child never reaped, three times in 6,200 interrupts against the handler and zero in 4,800 without it. Cycle 3 took the conservative fix: `main()` hands SIGINT back to `default_int_handler` as its first statement, so the handler covers startup and nothing else. **And the critic then corrected the measurement that was supposed to prove it** — the 12-way concurrent A/B this shift ran was close to vacuous, because under that load every interrupt lands in interpreter startup and never reaches the code under test; a `sitecustomize` probe on `Popen.__init__` settled it deterministically instead. A stress test that never reaches the code under test is not a stress test · **`screenshot.png` was stale, and not because of tonight.** Captured `732c44d` on 2026-08-23; `0082f60` renamed the rhythm denominator the next day, and the image had shown `the median week` against a build printing `the median busy week` for 25 days — with a caption reading "Captured from this build", so the README was untrue as printed, a **must-pass** line nobody had caught. Re-shot from the shipped tip · **the two must-pass lines two reviews had to leave UNVERIFIABLE are resolved here**: the critics' sandbox gets `403` from the GitHub API, so neither could confirm the repo's description or topics. From the hub's own credentials: MIT, description byte-identical to the README's opening sentence, topics `ascii-art cli developer-tools git no-dependencies python stdlib terminal`. Six of six · **[#66](https://github.com/yinggarykairui/factory-hub/issues/66) is relabelled `blocked`**, which is the other thing this night did. It is the true head of the `queued` list by one second and has been stepped over by every pick since 2026-08-23, because its five items each need the owner's taste or a redesign across all four panels — its own text says "none is a patch". §15 prefers `blocked` and an @mention to a guess; leaving it `queued` meant a queue head that every shift had to re-discover was unpickable · **[#65](https://github.com/yinggarykairui/factory-hub/issues/65) is open and `blocked`**, unchanged. Still no root `README.md`, still no LICENSE. It does not touch today — a CLI ship is not a `meta` ship — but it is still what breaks §16 clause 5 on every `meta` ship day · **The verification ledger, carried forward** (a later evening reads this before picking a debt candidate, §11): day 047 verified at `adbba83`; day 046 at `cea938e`; day 045 at `f67521c`; day 044 at `187b2e2`; day 042 at `df5db4f`; day 040 at `fcb1fec`; day 039 at `e23a18d`; day 038 at `57faf14`; day 037 at `bfb0fa8`; day 036 at `40bc8a2`; day 035 at `6279b06`; day 026 at `59a6820`. **The set, enumerated from the labels and arithmetically closed** — 31 verified + 20 not = 51. **Verified (31):** 001–003, 011–018, 023, 025–027, 029–033, 035–040, 042, 044–047. **Not verified (20):** 004–010, 019–022, 024, 028, 034, 041, 043, 048, 049, 050, **051**. 004–010 are evidence complete and relabelling still owed ([#116](https://github.com/yinggarykairui/factory-hub/issues/116)'s third residual, explicitly *not* a debt candidate under §11); 019 is the one demonstrable sha block and 020–022 and 024 are held by deploy scope ([#130](https://github.com/yinggarykairui/factory-hub/issues/130) item 4 is still open on whether that split is right); 028, 034, 041, 043, 048, 049 and 050 are `meta` ships that cannot get past #65; **051 is the newest and the easiest — a CLI ship with no deploy half, a recorded `sha:` and a recoverable base, blocked on nothing but a shift that had no hand in it.** Shipped at `9d18b82`, base `3824c71`.
...
to factory repos: `"yinggarykairui/palette-pull is not in this session's authorized repository set, so the proxy will not
inject a credential for it."` That is the wall that produced `HANDOFF.md` and has been recorded as a blocked plane on five
separate shift days, each one shipping over git and leaving its issue-plane writes as replayable text. **Both planes open
when the proxy is bypassed.** `curl --noproxy '*'` reaches the full REST API with `FACTORY_PAT` — issues, comments, labels,
close, the Pages build status — and
`env -u https_proxy -u HTTPS_PROXY -u http_proxy -u HTTP_PROXY -u ALL_PROXY -u all_proxy git -c http.proxy= -c https.proxy= push`
pushes normally. Every write in this run went that way: four pushes, a spec comment, two label transitions, an issue close,
a new issue. The factory already held **half** of this and never generalised it — `scripts/render_profile.py` has built its
opener with an explicit `ProxyHandler({})` since day 027, with a docstring saying scheduled runs must not fall through to
the sandbox's `HTTPS_PROXY`, and that knowledge stayed inside the one script that needed it. The gap between "one script
works around it" and "the shift knows the plane is reachable" cost five days of degraded runs. It is recorded at the top of
`HANDOFF.md`, where a shift that hits the 403 will look.*

*The day's build lesson is the middle cycle, not the ship. Cycle 1 was handed two true findings — the README's "four lines"
was false (the four `<li>` render as **5 lines at 1120 px and 10 at 360 px**; `.intro ul { max-width: 40rem }` means no
viewport makes it four), and two of the four bullets echoed the header sentence — and it answered both in the wrong
direction. It **cut two spec-mandated bullets**, which is a downstream role resizing the fence §4 draws and §7.2's feature
freeze exists to hold; and it closed the truth defect by replacing the count with **"a short block"**, a sentence nothing can
falsify, when §4's README-first rule makes the README the claim the build must satisfy. **All three cycle-2 critics rejected
independently on the same thing**, and the reason is the keeper: a block titled *What you get* no longer said what you get,
and **"swatch" — the noun both surviving bullets depend on — is introduced nowhere else on the page.** The header says
"colors" and "hex codes". The echo was the antecedent. The redundancy was real and the cut was still wrong, which is why it
went to [#91](https://github.com/yinggarykairui/factory-hub/issues/91) item 7 as a decision needing a spec line rather than
back into the diff — it has now been decided in opposite directions twice, and critic-ux's disposition is that the fix is one
rewrite of the **lede**, not a third cut of the bullets.*

*Two of the day's defects were introduced by fixes, not by features, and both were invisible to the check that was supposed
to catch them. The stagger left swatch 5 at opacity 0 for **186 ms while focusable and clickable** — a Tab landing a focus
ring on nothing — and the done-check asserted opacity at **t = 500 ms**, which skips the window entirely: the measurement was
the hole, not the feature. And cycle 1's own wrapped-share fix closed the empty band but left `.sw-meta { text-align: right }`
standing, so at 200 % zoom the share hung indented under the hex. A third fix shipped a **false measured claim in a comment**
— that the bar wraps "at 8.89rem at every root size from 16 px to 64 px", when it measures **9.29rem at a 28 px root and
8.43rem at 30 px**. The wrap point is a band, not a constant; the rule stayed and the claim was corrected in `29630d5`,
because a comment a maintainer cannot trust on the file's most fragile rule is worse than no comment at all.*

*The spec was wrong about the factory's own history, and the check that caught it was reading five repos instead of one.
It chose the footer `Day 014 (revisited day 032)` on the claim that `git-mood` and `maze-dash` "carry bare day numbers
because neither has been revisited" — `git-mood` was revisited on days 029 and 030 and still reads `Day 012`, `maze-dash` was
revisited on day 031 and still reads `Day 013`. `pixel-garden` reads `Day 001 (revisited days 003, 007 and 010)`;
`trace-lens` reads `Day 008` and `orbit-doodle` `Day 009` — the **latest** revisit, bare. Three conventions across five
repos, and STYLE.md's "verbatim except `<NNN>`" permits only one of them, so the footer was reverted to bare `Day 014`
(`09f0774`) and the inconsistency is filed for a `meta` issue. Two of three cycle-3 critics flagged the reversal as an
undocumented spec renegotiation; that is what this paragraph and the sign-off are for.*
...
`git log --format='%an <%ae>' f5c89f1..454746b | sort -u` prints **one line**,
`Kairui Ying <yinggarykairui@gmail.com>` — and the same range under `--format='%cn <%ce>'`, the command that
actually shows the committer half, prints that one line too. The branch
[`meta/42-authorship-per-clone`](https://github.com/yinggarykairui/factory-hub/tree/meta/42-authorship-per-clone)
carries the §14 canary; `main` fast-forwarded, nothing rewritten.*
...
*Verified mid-run, at 108 commits — five short of the merge tip `b92828a`, six short of the day's own
dashboard commit — `gitleaks` 8.28.0 clean in both `detect` and `detect --no-git`, with a positive control — a freshly generated `ghp_` literal and a new 2048-bit RSA key,
...
*Day 031 — `maze-dash`, [#45](https://github.com/yinggarykairui/factory-hub/issues/45). The reward used to land **308.6 px** from where the eye was, up in the HUD, while the board wiped and read as a reset. It now warms
towards amber for 200 ms on the board itself, drawn **under** the tether, arrow and runner so the amber marks keep their paper halos
and glow through it: paper `(250,248,244)` → `(239,222,211)` on the clearing frame, half the blue back by frame 4 (66.668 ms), exactly
paper again by frame 11 (183.337 ms), wall-to-paper contrast holding at **9.192:1** through the peak against 12.277:1 unwashed, and the
runner's centre pixel differing by **0 in every channel** between the peak frame and a no-flash frame — which is what proves the wash
passes under it rather than over it.*

*The other half of the day was a strategy nobody could see. Right-hand wall-following pays **1.833 mazes/run with 0 of 60 scoreless
runs**, against **1.050** (19/60) for never pressing and **0.150** (51/60) for steering at the ring — the only policy that guarantees a
score, because a perfect maze is a tree and one wall runs past every cell. It is now on a card inside `#overlay`, which is absolutely
positioned and never feeds `hintPx()`, so it costs **zero board pixels**: `CELL` identical to base at **0 of 700** comparisons over 350
viewport pairs in two screen states, with the same string appended to `#hint` instead as the negative control, which drops `CELL` at
**94 of 350**. That negative control is the whole point — the first attempt put the copy in the hint, and it shrank the board at
**41 of 186** height-bound pairs while the spec's own done-check reported clean.*

*Because that done-check could not see it. Its nine viewports are every one of them width-bound, `CELL`-capped, on the `sideCols`
branch, or pinned at the `CELL 11` floor, so nine passes were nine measurements of a clamp. It was replaced mid-run by a height sweep
with a cold load per pair and the rejected tip as the negative control — and two independent harnesses produced **phantom** regressions
until they stopped resizing one page, because base's `hintPx()` cached its reserve on `hintEl.clientWidth`, a width the showing sentence
itself determines, so narrowing while the sentence still fits never invalidates the cache.*

*The trap sentence was **scoped out** under §7.4 rather than reworded a fourth time, and the arithmetic is why: three cycles, three
wordings, three misreadings, each raced as a bot coded literally from the sentence as written. `Keep to the exit nearest your right`
reads as **screen**-right — 0.117–0.167 mazes/run, worse than not playing, from the copy written to stop the game punishing attention.
`Steering straight for the ring dead-ends` collides with the fallback clause one sentence earlier and inverts it to left — 0.267, 48/60
scoreless. `Steering for the ring dead-ends`, with that word removed, reads as *avoid the ring* — **0.000, 60 of 60 scoreless**, the only
policy of nine that never scores. The literal reading of what shipped wins; every misreading of it still loses to hands-off, which is a
property of stating a chirality rule in words for an **orientation-free token** — `drawRunner` is one `arc()` with no facing — and not of
any sentence. The honest cost is on [#89](https://github.com/yinggarykairui/factory-hub/issues/89): no screen now says the ringed cell
is the goal.*

*Four comment numbers this increment added were wrong, and all four fell to a critic who **recomputed** rather than read — a single
arrow-overrun formula covering two regimes it does not fit (`1.25 − 0.05C` quoted at the `CELL 11` floor, where the true value comes
from `2.5 − 0.12C`), a rendered-pixel pair obtainable under neither convention, a flash sample set out by **fiftyfold**, and a bot table
quoting day 013's human-cadence figures as though it had measured them. Every measurement in the file now names its policy, seed set,
`n`, seeding point, convention and frame; the seeding point alone moves hands-off from 0.750 to 1.050. Two pre-existing defects fell on
the way past: the results screen announced `new best` for runs far below the standing best, and the restart guard was shorter than an
ordinary mash cadence, so the score screen was destroyed 6/6 by the press you were already making.*

*All three cycle-3 critics REJECTED, and all three carried a ship disposition — (c), (b), (c). The (b) removal was applied, the (c)
must-pass clause was closed, and the combined re-vote on the tip approved. Then the evening shift arrived at 20:07 PT, found the repo
still moving under it, **stood down instead of finishing it**, and recorded an independent two-critic APPROVE — plus the finding that
outlives the day: `yinggarykairui.github.io` is refused to `curl` at the network layer, but **`WebFetch` is not**, and with a unique
cache-buster it returns the true tip. The seventh must-pass line, blocked for eight weeks, is cleared. Without the cache-buster the
first fetch served copy that existed only between two intermediate commits — a demo check without one can pass against a build that no
longer exists.*

---

*2026-09-09 evening shift — day 046 (`tool-loop-viz`) polished across three cycles and then verified at
`cea938e`. The §7 loop cap is spent; 22 commits, `764e949..cea938e`, four pushes, authorship asserted over
the run's whole range before each (§9.2) — exactly one line, `Kairui Ying <yinggarykairui@gmail.com>`, author
and committer alike, and zero `Co-Authored-By` / `Claude-Session` / `Generated with` trailers in any of the
22 bodies. Feature freeze held: every commit closes a defect or corrects a false statement.*

*Cycle 1 opened **3 REJECT / 1 APPROVE**, and what the critics rejected on was **the day's own two headline
items being false one keystroke after they were met**. Every non-error status was recorded as the page's
last-good line, transient `Reading <file>…` progress lines included — so a refused PNG showed its correct red
refusal and a single `ArrowDown` replaced it with `Reading screenshot.png…`, unstyled, announced through
`role="status"` as though a read had begun that never would. And the refusal was **invisible**: the viewport
was byte-identical before and after a refused drop, `#status` sitting 135 px below the fold at 1280×800 and
530 px below at 320×568, while a **successful** drop scrolled the reader to the summary. Both are now closed
and measured at five viewports in both motion modes. A third: the timeline and the summary printed tool names
the transcript does not contain — `read_file` + U+202E + `txt.esrever_yortsed` rendering as
`read_filedestroy_reverse.txt` on the two surfaces the page exists to be trusted about, while the detail pane
escaped it correctly, contradicting the file's own comment.*

*Cycle 2 took the re-verify to **3/3 APPROVE** and spent itself on the residue: every drop now says what
became of it (the busy guard cycle 1 added was correct and silent; a drag carrying only `text/uri-list` was a
total no-op; a multi-file drop named only the first), both advertised shortcuts became true from everywhere
the hint promises them, and folding the tool list below 48 rem takes the 704–767 summary strip from 148 px to
57 px — a band this day had itself re-tuned — while gaining the 320 px phone a whole timeline row.*

***The README change is where the two critics disagreed, and the disagreement is the record's real content.***
*critic-ux drafted a compression of a section running 16 sentences against `STYLE.md`'s 2–5. critic-hygiene
objected that this exact paragraph had been re-broadened into a falsehood by a length rewrite **twice today**
— `e420ca5` narrowed "anything that fails to parse" to "a transcript that fails to parse" because the broad
form was false, `885da51` rewrote the paragraph for length and silently restored it, and cycle 1's `2f19e71`
narrowed it a third time — and named seven strings that could not be re-cast. Hygiene's method won: the caps
and input-handling paragraphs were **relocated verbatim**. Verified as a pure move rather than taken on trust
— **lines removed: none**; lines added: the heading and one blank; word multiset identical at 408; all seven
protected strings matching raw-exact, the control-character sentence still adjacent to the one that stops it
being read as a general binary filter. `## What it does` went 16 sentences to 7. critic-ux then conceded the
method on the record: "Verbatim relocation was the correct method under a same-day freeze." The trade is
named rather than hidden — the README now carries a fifth section between "How to run" and "Why it exists",
which is a deviation from the template's shape, taken because the only route to the template's number was the
operation that had already put two false clauses in this file today.*

*Cycle 3 closed four one-liners, **two of them regressions this evening had caused**: deleting `button` from
`takesOwnKeys` also let `ArrowDown` throw away a value the reader had just expanded (closed by a named-class
exception, not by putting the tag term back), and revealing every **refusal** left the one success message
that reports a destructive side-effect as the only message that does not reveal itself. The third was **a
wrong number in a comment this evening wrote** — it claimed folding the strip buys a sixth timeline row, when
`.timeline`'s computed `max-height` is 440 px on both sides, so what it buys is 90 px of page. Two critics
found it independently, by recomputing rather than reading; the mistake was counting rows whose rect fell
inside the **window** rather than inside the list's own scroll box, which `getBoundingClientRect` does not
clip. The stale figure survives in `e7bee4b`'s commit message and was left there rather than rewritten (§15).*

*Declined on the record rather than quietly: a `<noscript>` element (new scope under §7.2); reordering the box
write ahead of the parse, which would close [#124](https://github.com/yinggarykairui/factory-hub/issues/124)
item 1 — a dropped file over 400,000 characters still destroys typed box content while the status says the run
is unchanged — but collides with the shipped README claim that a failed paste is never cleared; the
pre-scrolled narrow timeline (#124 item 7); and the phone hint's wording. **`LESSONS.md` gains nothing from
this shift**: §14 allows one line a day and the 2026-09-09 slot is spent by the noon shift's. Two candidates
are parked in the verification comment for a shift with a free slot.*

*Closing scores from each critic's **final** position, attributed rather than averaged into anonymity: delight
4/4/4 (correctness/ux/hygiene) → 4.00 · clarity 4/4/5 → 4.33 · readme 4/4/5 → 4.33 · scope 5/5/5 → 5.00,
giving **4.42** against the 4.25 the day shipped at. **The index row's rubric figure is deliberately left at
4.25** — that is what the day shipped at, the row is the noon shift's record, and neither §9.8 nor §11 asks an
evening to re-score one. The `avg rubric score` KPI is unchanged for the same reason. **No verification debt
was paid**: §11 bars starting a past-ship check with under 45 minutes to pencils-down, and the three cycles
ran to 23:15 PT. No open `job` issue, so §17 had nothing to service.*

*One capability worth carrying forward, because §11's own text assumes its absence. The manual records that
three of the five §8 lines in a web ship's draw pool — loads/runs without errors, survives garbage input,
usable at phone width — "need a browser this shift does not have", so roughly three draws in five are
unavailable whatever the ship's condition. **This sandbox has Chromium at `/opt/pw-browsers` with Playwright
configured against it**, so all three are answerable, and tonight's draw was one of them. Every critic in this
run drove the real page rather than reading it, which is why the two reject-level findings were behavioural
rather than textual. If that holds for other scheduled sandboxes, §11's verification-debt paragraph is worth
considerably more than its own dry run measured.*

---

*2026-09-10 evening shift — day 047 (`critic-loop`) polished across three cycles, corrected once more
under directive 1, and then verified at `adbba83`. [The verification](https://github.com/yinggarykairui/factory-hub/issues/61#issuecomment-5629678515).
Sixteen residuals filed as [#127](https://github.com/yinggarykairui/factory-hub/issues/127). The shift's
content is that **every cycle after the first was cleaning up the cycle before it**, and the record is kept
that way rather than presented as three tidy improvements.*

*Cycle 1 (playtester APPROVE, all three critics REJECT) found the day's ship carrying a **false must-pass
claim** and a **silent export defect**. The README said live mode *"has been exercised against a mocked
transport — every error path, the lenient JSON parse, abort"*; `grep -c fetch tests.html` is **0**, and the
suite's only `abort` assertion drives the engine generator's `.return()`, not `app.js`'s `AbortController`.
The exported Markdown transcript dropped `mean word (chars)` and printed `mean sentence` where the on-screen
strip suppresses it, so the **"Almost clean" export was byte-identical before and after a pass the same file
records as `Applied: 3 of 3`** — the sample the page offers first exporting as "nothing moved". The UTF-16
miscount disclosed for one helper on [#125](https://github.com/yinggarykairui/factory-hub/issues/125) was in
**three** counters. The `Samples` label sat **0 px** below Run — 0 px from the control it does not label,
5.6 px from the ones it does — at every width above 26 rem, not "768 up" as that fix's own commit message
says. And below 26 rem every closed quote was a fixed slab, 250 px at 320 and 320 px at 390 whatever was in
it, so `"holistic"` got `"at this point in time"`'s box and 14 of 21 findings read as empty input fields.*

*Cycle 2 (all three REJECT) rejected **two of cycle 1's own fixes**. Moving three counters to code points and
leaving two run limits on UTF-16 units made the page contradict itself in the same unit word: a draft the
counter called **3,077 characters** was chunked by a 6,000-character limit and refused a word diff by a
12,000-character one. And the sentence written to replace the false coverage claim **carried its own wrong
number** — "22 assertions" where instrumenting the suite gives **25** calling `apiErrorMessage` and **32** in
the block. The closed-quote fix had traded one defect for another: shrink-wrapped quotes now shared the
summary line whenever they happened to fit, so one panel's quote column ran x = **41, 120, 230, 41, 178** —
a column with no column, on a rule invisible from outside the stylesheet.*

*Cycle 3 closed those and **broke the same class again, one layer down**. Migrating the two run limits to code
points left the chunk note printing a code-point total beside a UTF-16 chunk size, so `6,001 characters … 4
chunks of about 3,000 characters` **did not divide** — and the README sentence written beside it, *"every
'characters' on this page is a count of Unicode code points"*, was false about that figure and about live
mode's input ceiling. **The loop cap was spent and the fix was taken anyway**: directive 1 outranks a cycle
budget, and a §8 must-pass line knowingly left failing is not something a spent budget buys. The note now
reports the mean code-point size of the chunks it produced, which **divides for ASCII too, where it never
did** — a 7,000-character ASCII draft used to claim `3 chunks of about 3,000`. The live-mode message names
its own unit instead of calling units characters, and the test behind it is untouched, so nothing changed
about what is sent to `api.anthropic.com`. A first attempt at the quote fix made the summary a block, passed
every width it measured, and pushed `pointer only` **11 px past the panel at 200 % text zoom**; it was
replaced by a full-width `summary::after` flex break rather than shipped.*

*Suite **1,604 → 1,867 assertions**, all passing, in four new groups. 21 commits, `3b73c74..adbba83`,
authorship asserted over the run's whole range before each of three pushes (§9.2) — exactly one line,
`Kairui Ying <yinggarykairui@gmail.com>`, and **zero `Co-Authored-By` or `Claude-Session` trailers**
([#112](https://github.com/yinggarykairui/factory-hub/issues/112)). gitleaks 8.28.0 clean in `git` mode over
**77 commits** and in `dir` mode over the worktree, behind a positive control of freshly generated random
values that fired **3 hits in each mode** before any clean result was read.*

***The evening's cost, stated rather than rounded: the page is about 25 px taller at 320 px than the ship, not
shorter.*** *Measured on both trees with one script — `corporate` 7,228 → 7,253 px, `hedged` 7,309 → 7,335,
tallest panel 1,181 → 1,192 and 1,212 → 1,230. critic-ux accounted for every pixel: the shipped tree already
broke closed quotes onto their own line below 26 rem, so the `::after` adds no line of content, only one
1.6 px `row-gap` per closed row. What was bought is a closed quote's dead air going from **184–270 px to a
constant 19 px** of its own padding, at one left edge, at every narrow width. The `mean word (chars)` column's
own cost was re-measured and is **52–72 px per draft panel at 320**, not the "20–30 px" day 047's sign-off
estimated; **seven** CSS-only candidates were measured and none was taken, because the only two that saved
real height detached labels from their values — at 320 the strip rendered `"(−0.1)hedges 0 (±0)"`. The number
is filed on #127 as a decision, not carried as an impression.*

***Deploy-scope was answered with more than §11 assumes is available.*** *Step 1: `git rev-parse origin/HEAD`
equals the sha under test. Step 2, the HTML marker §11 asks for: `Almost clean` is added to `index.html` by
`git diff 59a6820..adbba83`, present at `adbba83` and absent at day 026's `59a6820`, and a cache-busted
`WebFetch` returns the four sample labels with it first — which bounds the served tree inside day 047's own
range. **Then the served `app.js` was fetched directly**, and it returns as text rather than markdown,
carrying three literals this evening introduced (`meanChunkChars`, `pairLongerThan`, `' UTF-16 units, and
live mode sends at most '`), each absent at `3b73c74` and `59a6820`. That pins the deploy to the evening's own
tree rather than to the day's range. `LESSONS.md` records the HTML transport's ceiling — it proves which
document is served and cannot prove the app runs; **fetching the script raises the floor without raising that
ceiling**, and is the first of two candidates parked for a shift with a free `LESSONS.md` slot (§14 allows one
line a day and the 2026-09-10 slot is the noon shift's). The second: a migration that changes a unit has to
change every reader of that unit in the same commit, or the page starts contradicting itself in the word it
just made precise — cycle 2 moved three counters and left two limits, cycle 3 moved two limits and left the
note's own divisor.*

*The fourth sub-check drew **"Web: usable at phone width"**, seeded `critic-loop day-047 evening 2026-09-10`
so the draw is re-derivable. PASS: 320/360/390/414 px under mobile emulation with touch, all four samples
driven to completion, 16 runs — `scrollWidth − clientWidth = 0`, zero elements escaping the viewport box, zero
leaf elements clipping text without an ellipsis, zero page or console errors, and clean at 320 with 200 % text
zoom. The two controls under 24 px are the native 13×13 radio inputs inside 57 px and 78 px label rows. That
is evidence for [#122](https://github.com/yinggarykairui/factory-hub/issues/122) rather than an argument about
it: the draw landed on one of the three lines the 2026-09-06 evening called unavailable, and it was answerable,
because this sandbox has **Chromium at `/opt/pw-browsers` with Playwright configured against it** — the second
consecutive scheduled evening to find it there.*

*`screenshot.png` was **re-checked rather than assumed**, because this evening changed `style.css`.
`index.html` and `critic.js` are byte-identical across `3b73c74..adbba83`; every CSS rule added tonight except
the `.samples` margin lives inside `@media (max-width: 26rem)` and cannot apply at the screenshot's 1180 px;
and `.samples` sits in the input card above the crop. Rendering the transcript at 1180×1370 @ dSF 2 on both
trees gives identical content, the pixel difference being a **0.39 px fractional offset** of the transcript's
own top (878.25 → 900.64) re-antialiasing every glyph.*

***Two things this evening got wrong and did not quietly fix.*** *A playtester finding — that live mode fires a
request with an empty model — **did not reproduce**: `els.model.value.trim() || 'claude-sonnet-4-5'` has always
defaulted it, and the fixer reported that back instead of building a guard against a phantom. And two commit
messages written tonight assert things their diffs do not: `5da8790` describes a block layout that `60619dd`
replaced, and `54fb882` silently included a scratch file (`README.md.f2`, a draft of the README, no
credentials) that `4e76842` removed. §15 forbids rewriting published history, so both stand and are corrected
here and on #127 — the same choice day 047 made with its own stale figure in `e7bee4b`.*

***Verification debt: one payment, five skips.*** *The mandate finished at 21:57 PT with 123 minutes to
pencils-down, well clear of §11's 45-minute floor, so debt was reached. Candidates were taken lowest day
number first. **Days 019, 020, 021, 022 and 024 all skipped on the same gate** — their build issues resolve
cleanly, but no sign-off records a sha and neither does this file, so there is no tree to check out. Day 019's
is *inferable* (`20810e2` is the base day 038's sign-off records) and was skipped anyway, because that is day
038's base rather than day 019's recorded ship, and a `verified` is unrecoverable under §3. **Day 045**
(`noise-poster`, [#58](https://github.com/yinggarykairui/factory-hub/issues/58)) had one — `015822a..f67521c`
— and **Passes at `f67521c`**: [the spot-check](https://github.com/yinggarykairui/factory-hub/issues/58#issuecomment-5629727650). Its deploy half is the case that shows why fetching the
script matters — **day 045 touched only `app.js` and `style.css`, leaving `index.html` untouched**, so the
HTML channel §11 assumes could not tell day 045's tree from day 024's, while the served `app.js` returned
`function reroll()` and `const changed = next.seed !== state.seed …`, both absent at `015822a`. A maintenance
day that touches no HTML is the commonest day this factory ships. Its fourth sub-check drew **phone width**
too, and passed across 20 probes — five widths under touch emulation, each driven through Shuffle, a palette
change and a hostile seed, with zero overflow, zero escaping elements and zero errors. No open `job` issue, so
§17 had nothing to service.*

---

**Day 048 — 2026-09-12 — `factory-hub` (meta), [#62](https://github.com/yinggarykairui/factory-hub/issues/62), shipped `f9775b6`.**

*The day opened on a **zero day**. The last trace of any shift before this one is 2026-09-11 05:01 UTC — 22:01 PT
on 09-10, the previous evening pushing its own dashboard update. Nothing on 2026-09-11: no ship, no verification,
no issue touched on either plane. The fifteen-day streak ends there and
[#93](https://github.com/yinggarykairui/factory-hub/issues/93) gains a seventh date. Both planes were open to this
shift on the first try, so whatever stopped 09-11 was not the sandbox.*

***The residual had grown teeth in the twenty-two days since it was filed.*** *#62 measured the `LESSONS.md`
datestamps as three days into the future. Re-derived from the file today: **43 of 60 stamps were queue slots**,
the worst **ten days** ahead of its work — the day-045 noon shift ran 2026-09-08 and was stamped `2026-09-18` —
with six entries dated in the future and the file not date-ordered at all. **The rule had already been abandoned
without anyone recording it:** the day-046 and day-047 noon shifts stamped their real dates, `2026-09-09` and
`2026-09-10`, directly beneath an entry stamped `2026-09-18`. One-per-**day** plus "take the next free slot" is a
queue, and a two-shift factory overflows it daily. §14 now stamps by the date of the work and caps at one per
**shift**, and all 43 entries moved to the truth — recovered from each entry's own parenthetical against this
file's day→date index, then stably re-sorted, **with no lesson body edited**.*

***The fix's own first pass was the day's best finding.*** *Run read-only before it was applied, the migration
mis-attributed **7 of 43**: the regex looked for a shift anywhere in the parenthetical, and every parenthetical
ends with the list of *other* shifts whose slots were spent, so `the 2026-08-21 evening shift's lesson; … spent by
the day-025 noon …` came out stamped 2026-08-18. Six of the seven get a wrong date; the seventh names the wrong
shift and lands on the right date because that shift ran the same day. It is the day's `LESSONS.md` line.*

***Re-stamping breaks citations, and the first fix for that was not enough.*** *Keeping the old slot in each
parenthetical makes an entry **findable**, not **resolvable**: **33 of the 42 slots are now live stamps on a
different entry**, so a search for `2026-08-14` returns the entry that used to hold it and an unrelated lesson now
stamped that date. `LESSONS.md` gains a **43-row old-slot map** and a range test — every date from 2026-08-07 to
2026-09-18 except 2026-08-09 is in it. Twenty affected references, counted by hand: eight in lesson bodies here,
twelve in `HANDOFF.md` and the dashboard. **The map cannot reach those twelve** and
[#129](https://github.com/yinggarykairui/factory-hub/issues/129) says so.*

***Nine cycles of the same defect, in a build about that defect.*** *Review record: **cycle 1 all three REJECT**,
**cycle 2 all three REJECT**, **cycle 3 all three REJECT** — every one of them chiefly on **false numbers in the
build's account of itself**, while the migration was correct from the first pass and never wavered. The loop cap
was spent at cycle 3, whose own rejections were four errors cycle 3 had just introduced; under directive 1 and day
043's precedent those were closed as scoped post-cycle fixes and the §7.3 re-verify was run instead — **1 APPROVE
/ 2 REJECT**, all three converging on one stranded numeral, plus the 95-character citation rule still shipping
verbatim in `LESSONS.md` after being scoped out of `MANUAL.md` only. **Second re-verify: 3 APPROVE.** That rule is
scoped out under §7.4: offered as the thing that made the count re-runnable, it returned three different answers
to three reviewers, none of them 20.*

***Two process failures the build volunteered rather than buried.*** *A commit message reported the last
four-word edit as landed when the script applying it had aborted on a failed assertion before writing — the
build's own bookkeeping committing the class of defect it spent three cycles on; `f9775b6` records it. And the
**canary**: §14 requires one for §7–§9, the first pass reasoned it was exempt as a §14/§16 edit, and that stopped
being true the moment §9's step 9 had to change too. A branch and a dry run went in after the fact, but `5a627b1`
edited §9 step 9 again and went straight to `main`. A fast-forward also leaves a record indistinguishable from
committing to main directly — a later canary-list `meta` edit should merge `--no-ff`.*

***§16's other half.*** *§16 listed the dashboard Pages site and the profile storefront under Phase 2 while §9.8
has ordered both on every ship since 1.1.3/1.1.4. For **seven weeks** the phase gate read as a prohibition on the
shipper's daily work and the pull-forward lived only in the changelog. Both are now standing exceptions.*

*Twenty-four assertions over the shipped tree, all enumerated in the sign-off and all re-derivable from the repo.
gitleaks 8.28.0 clean in `dir` mode over the worktree and `git` mode over 231 commits, each run behind a positive
control of freshly generated random values asserted to fire first. Nine commits, `0fd4d77..f9775b6`, authorship
asserted over the run's whole range before each of five pushes — exactly one line,
`Kairui Ying <yinggarykairui@gmail.com>`, zero trailers. Must-pass 3/5: the two that fail are the hub's own
missing LICENSE and root README, [#65](https://github.com/yinggarykairui/factory-hub/issues/65), pre-existing and
...
*The mandate finished at 20:35 PT with 205 minutes to pencils-down — well clear of §11's
45-minute floor — so **verification debt was reached, and it paid four times.** Candidates
lowest day number first. Days 019–022 and 024 were re-checked on the sha gate and are
unchanged: §10 still records no sha and neither does this file. **Day 011 was opened and is
already `verified`** — the first sign that the ledger above was describing a different
factory from the one the labels describe, which is why this evening enumerated the whole set
from the label plane and closed it arithmetically. Day 028 carries an* `EVENING REVIEW
day-028` *comment — evidence a past shift gathered and never relabelled on, which §11 says to
skip rather than to relabel on second-hand.*

***Day 035** (`boids-tank`, [#49](https://github.com/yinggarykairui/factory-hub/issues/49)) **Passes at** `6279b06` — [the
spot-check](https://github.com/yinggarykairui/factory-hub/issues/49#issuecomment-5650765997). It cleared every gate, and it is the **only** candidate in the
whole ledger whose deploy half is still confirmable: `boids-tank` is the one repo whose most
recent ship is the ship under test, so §11's step 1 — nothing newer exists — is answerable for
it and for nothing else. Day 035 was itself a §11.4 evening rescue, barred by §16 clause 2 from
verifying what it built, and its sign-off said in as many words that tomorrow's evening might
pay it. Fourteen days later, this is that.*

*The sign-off's one ambiguity resolved from the repo rather than being guessed at: the critics
line names* `7e93d49` *as the re-verify sha and the authorship line gives the range*
`1c7203c..6279b06`, *and* `6279b06` *is* `7e93d49`*'s child and the tip. Repo half: the
screenshot is present and referenced, and gitleaks is clean over 37 commits in* `git` *mode
and over the worktree in* `dir` *mode, behind a control of freshly generated values read
**first** at 2 hits. Deploy half, on two channels: the demo's control rows return* `cohesion
50% · alignment 62% · separation 75%` *— the changed readout at the ship's value with the two
unchanged ones beside it as controls, and the only other* `75%` *in the pre-ship tree is
inside a CSS comment that does not survive the conversion — and the served* `boids.js`
*carries* `SEP_CURVE`*,* `trustedMapper` *and* `sliderToSeparation`*, all absent at*
`1c7203c`*, plus* `Read the eighths figures as indicative, not as a bound.`*, the line*
`6279b06` ***itself*** *added. That pins the deploy to the ship's final commit rather than
inside its range — it excludes* `7e93d49` *too.*

*The fourth sub-check drew **"loads/runs without errors on first use"**, seeded* `boids-tank
day-035 evening 2026-09-12` *so the draw is re-derivable. **PASS** over 14 runs — seven frames
(1440×900 at dpr 1 and 2, 1180×820 at 1.5, and 320/360/390/414 at dpr 3/2/3/2) × two pages —
plus three cold loads in one context: zero* `console.error`*, zero* `pageerror`*, zero failed
requests, and* `scrollWidth − clientWidth = 0` *at all seven widths, which came free. The
local server was asserted byte-identical to the clone before a page was opened, per*
`LESSONS.md`*'s 2026-08-01 line about grading a stale bundle.*

***And the shipped suite was polled rather than sampled, which is the night's lesson in
miniature.*** `tests.html` *seeds its verdict red in* `<head>` *and yields across frames, so at
4 s it still reads* `{"total":0,"ok":false}` *under a* `FAIL` *title — exactly as day 035
designed it, and exactly what a poller too impatient to wait would file as a defect. Held to
10 s it flips to* `{"pass":48,"fail":0,"total":48,"ok":true}` *and to a* `PASS` *title. The
sign-off's claim that a poller can tell **failed** from **hung** is true, and the red-then-green
sequence is the evidence for it. A first draft of this evening's finding list had that
4-second reading in it as a defect.*


*Three more payments followed day 035, and they came from **reading the dashboard's own
ledger sceptically rather than taking it.** Two sentences in it had to be disbelieved first.*

***"day 042 [stands unverified] for clause 2"** and **"day 044 is not verified and cannot
be — §16 clause 2, its evening built what it would verify."*** *Both are true about those
**evenings** and neither is a property of the **ship**. §16 clause 2 decides whether a night
counts toward graduation; §11's gate is* "only a ship **this shift** had no hand in", *and
this shift had none. Read as written — especially* "cannot be" *— the ledger would have
parked two fully checkable ships permanently on the strength of a rule about someone else's
night. Both **Pass**.*

***Day 039** (`sprite-stamp`, [#53](https://github.com/yinggarykairui/factory-hub/issues/53)) **Passes at** `e23a18d` — [the
block](https://github.com/yinggarykairui/factory-hub/issues/53#issuecomment-5650830594). The marker was derived by diffing **DOM text nodes** rather than
grepping the file, because a grep cannot tell what survives the conversion: that diff has
exactly one addition,* `Grid`*, the toggle this ship added, occurring **0 times** anywhere in*
`index.html` *at* `d74b16f`*. The live page returns* Erase, Mirror, **Grid**, Undo, Clear,
Export*. **Its draw was the hard one — "README is truthful and says how to run it" — and this
README is unusually exposed to it**, because day 039's own commits put numbers in it. All
**18 of 18** claims hold, measured in Chromium: the 16 px step and the 256–512 clamp over 120
viewports;* "a 559 px wide window draws a 416 px board and a 560 px one draws 512 px" *— 416
and 512;* "a 512 px board also needs 860 px of height" *— 859 gives 496, 860 gives 512;* "at
900×603 and at 1440×400 the board is 256 px" *— both 256; the 604 px one-column threshold and
the 536 px side-by-side one; twelve colours; Grid off by default and the grid-on and grid-off
exports **byte-identical at 2,412 bytes**; a 256×256 PNG at colour type 6; strokes surviving a
reload; Clear undoable.*

***Day 042** (`snake-flee`, [#56](https://github.com/yinggarykairui/factory-hub/issues/56)) **Passes at** `df5db4f` — [the
block](https://github.com/yinggarykairui/factory-hub/issues/56#issuecomment-5650848914)*. **Its HTML channel could not settle step 2 and the script channel
did**, *which is worth recording as the pattern rather than the exception: the day's only two
added text nodes live inside* `<p id="overlayRecord" hidden>`*, so the conversion drops them
and the fetch returns the same visible text either tree would. The served* `app.js` *carries*
`overlayRecord` *and* `'the board is full · score '`*, both in **zero** files at* `3091762`*,
the second being the day's headline change in one string. Its draw was LICENSE/description/
topics: MIT at root and untouched by the ship, a description **byte-identical to the README's
opening sentence**, eight topics.*

***Day 044** (`regex-lab`, [#57](https://github.com/yinggarykairui/factory-hub/issues/57)) **Passes at** `187b2e2` — [the
block](https://github.com/yinggarykairui/factory-hub/issues/57#issuecomment-5650870547). **This is the pure form of the case §11 warns about:** the day's diff
touches* `README.md`, `app.js`, `style.css` *and* `screenshot.png` *and **not* `index.html` *at
all**, so the DOM-text diff across the two shas is **zero additions and zero removals** and the
HTML channel has nothing to distinguish with. Through that channel alone step 2 is
*unavailable* and a sound ship takes a Skip. The served script settles it:* `ENGINE_HEAD`,
`ENGINE_KEEP`, `ENGINE_TAIL`, `elisionMark` *and* `engineParts`*, all five in **zero** files
at* `3f7cbd0`*. Its draw was loads-without-errors, and **first use meant using it**: typing*
`(a+)+$` *against* `aaaa…X` *produces* "Pattern took longer than 400 ms and was stopped."*, the
field keeps focus, and* `a+` *then reports* "1 match." *— day 023's Web Worker kill still
working at day 044's tip, zero errors across seven frames and the whole sequence.*

***What the next evening inherits.*** *The payable set is **empty**. All seventeen remaining
unverified ships are blocked on one of three things, and two of them are a few minutes of the
owner's time: **[#65](https://github.com/yinggarykairui/factory-hub/issues/65)** — a LICENSE and a root README at the hub — unblocks
days 028, 034, 041, 043 and 048 **and stops §16 clause 5 from breaking every `meta` ship day**,
which is the single largest obstacle standing between this factory and phase 1. **A sha field
in §10** (or [#94](https://github.com/yinggarykairui/factory-hub/issues/94)) unblocks days 019–022 and 024. The last seven, days 004–010,
are [#116](https://github.com/yinggarykairui/factory-hub/issues/116)'s relabelling, which §11 deliberately forbids an evening to do. Until
one of those moves, an evening that reaches debt has nothing to spend it on — and that is a
better state to inherit than a backlog, because it names the two fixes that dissolve it.*
