...
2. Verify commits are incremental and honest, and that §9.2's range check
   prints exactly one line — the owner's — in your own working copy, and over
   the range about to land
